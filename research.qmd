...
I like research! I primarily research boreal forests right now, partly because I live in them.

![](images/Research.pdf){fig-align="center"}

Below are a few of the questions I currently and historically work on - not an exhaustive list though, since I have a weak spot for shiny new research questions. 

### **How does increasing fire frequency impact boreal forests?**
...
### How do we manage boreal forests in a time of change?
...
To address this knowledge gap, I led the intellectual development of a co-produced project funded by the Joint Fire Science Program. I pair manager expertise with process-based landscape models to explore how strategies such as thinning, prescribed burning, reseeding or suppression maintain carbon storage in boreal forests of Interior Alaska across the next century. Working with interdisciplinary and multi-institutional collaborators, including the Alaska Dept. of Fish and Game, the Woodwell Climate Research Center and the Alaska Fire Science Consortium, our team will test the effectiveness of various human interventions in preserving or protecting legacy carbon in Alaskan forests.
...
If you're interested in hearing me ta lk more about my work, I've given public seminars at the Cary Institute of Ecosystem studies (link https://www.caryinstitute.org/news-insights/scientific-seminar-video/how-herbivores-fire-and-climate-change-are-shaping-alaskan
