...
I'm a climate change ecologist, and an Assistant Professor in the Department of Environmental Science at Western Washington University. I work in the intersection of paleoecology, landscape ecology and disturbance ecology, using field, lab, and modeling tools to study how ecosystems change over space and time.
...
While setting up my PhD field sites, I stumbled down a herbivory rabbit hole after noticing intense browsing from moose and hare in my reburned plots. Through an NSF Postdoctoral Fellowship, l worked with [Winslow Hansen](https://www.caryinstitute.org/science/our-scientists/dr-winslow-d-hansen) and [Jill Johnstone](https://npelusask.weebly.com/) to use process-based landscape modeling to explore whether herbivores like moose and hare might interact with fire to shape forest composition and carbon at a landscape scale.

I spent a year in Fairbanks, Alaska, as a term Assistant Professor in the Department of Natural Resources, working with the Alaska Fire Science Consortium and getting really into cross country skiing.
