...
You can download a Data Export of your collection from the Dashboard. This will include:
...
To connect to the Discogs API, go to Discogs Developer settings once logged ion. From there, you create a new application and generate a user token.
...
With your token in hand, you can use the **httr** package [@httr] to call the API with your username.
