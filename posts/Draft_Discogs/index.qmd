...
Knowing what you can collect requires understanding what's actually available. **collecdata** is a list of 1588 elements, each element representing a vinyl in the collection. Within each element are additional lists of data. **basic_information** contains
...
collection <- lapply(collecdata, function(obj){
  data.frame(release_id = obj$basic_information$id %||% NA,
             ...
             genre2 = obj$basic_information$genres[[2]] %||% NA,
             style1 = obj$basic_information$styles[[1]] %||% NA,
