...
Then, I can simply make a copy of that folder to start a new post. Make sure to update the date to the publication date - using *today* and *last-modified* in the internal workings of the quarto document means more rendering in the background ([per the Quarto documentation)](https://quarto.org/docs/websites/website-blog.html).

## Adding Comment Sections

# A non-exhaustive list of Quarto resources I found useful
